...
<body>
    <div class="container">
        <h1>Stay Keisha Free</h1>
        <h2>How I'm Pulling Up On Em'in Brazil</h2>
        
        <img src="https://media.tenor.com/xkDP4Akzx_UAAAAM/howdy-tom-and-jerry.gif" alt="Cowboy_Tom" class="hero-image">
